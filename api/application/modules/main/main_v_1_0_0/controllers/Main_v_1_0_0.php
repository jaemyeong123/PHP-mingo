...
class main_v_1_0_0 extends MY_Controller{
    ...
    $this->load->model('main_v_1_0_0/model_main');
	}
	...
	public function main_detail(){
	  ...
	  $page_num = $this->_input_check('page_num',array("ternary"=>'1'));
		...
		$result_list = $this->model_main->main_list($data);//공지사항 리스트
		$result_list_count = $this->model_main->main_list_count();//공지사항 리스트 총 개수
		...
		foreach($result_list as $row){
			$data_array[$x]['main_idx']	= $row->main_idx;
