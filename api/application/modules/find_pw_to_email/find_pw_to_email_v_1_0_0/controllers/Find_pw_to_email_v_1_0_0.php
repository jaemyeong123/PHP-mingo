...
class Find_pw_to_email_v_1_0_0 extends MY_Controller {
  ...
  function __construct(){
	...
	public function index(){
		$this->member_pwd_reset_send_email();
	}
    ...
    $member_phone = $this->_input_check("member_phone",array("empty_msg"=>"전화번호 입력해주세요."));
    ...
    //$member_id ="rladhrgns@rocateer.com";
		...
		$message = $this->load->view('find_pw_to_email_v_1_0_0/view_find_pw_to_email', array("data"=>$data), true);
