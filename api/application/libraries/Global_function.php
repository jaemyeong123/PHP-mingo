...
Class Global_function {
	...
	function get_del_yn($str){

		switch ($str) {
			case 'R' : $rt ='승인요청'; break;
			case 'N' : $rt='이용중'; break;
			case 'P' : $rt='이용정지'; break;
			case 'Y' : $rt='탈퇴'; break;
			default : $rt="";break;
		}
		return $rt;
	...
	function get_member_company($str){

		switch ($str) {
			case '0' : $rt ='베스트엘씨'; break;
			case '1' : $rt='월드모기지'; break;
			case '2' : $rt='케이스타모기지'; break;
			case '3' : $rt='케이플러스모기지'; break;
			case '4' : $rt='윈모기지'; break;
			case '5' : $rt='글로벌모기지'; break;
			case '6' : $rt='에이플러스모기지'; break;
			case '7' : $rt='모기지파트너스'; break;
			case '8' : $rt='하나더모기지'; break;
			case '9' : $rt='하나엠엠씨'; break;
			case '10' : $rt='하나지엠지'; break;
			case '11' : $rt='하나피엠씨'; break;
			case '12' : $rt='환은모기지서비스'; break;
			case '13' : $rt='홈앤모기지파트너스'; break;
			case '14' : $rt='네이처휴먼모기지'; break;
			case '15' : $rt='우리나라'; break;
			case '16' : $rt='다도움'; break;
			case '17' : $rt='아이오파트너스'; break;
			case '18' : $rt='토탈모기지'; break;
			case '19' : $rt='그 외'; break;
			default : $rt="";break;
		}
		return $rt;
	}

	function get_member_gender($str){
...
// 기본 페이징 출력
  ...
  //핸드폰 형식세팅2
	function set_phone_number2($str){
		if($str){
			$rt = substr($str,0,3).".".substr($str,3,4).".".substr($str,7,4);
		}else{
			$rt ="";
...
//시간 ':' 제거
  ...
  //레포트 상태
	function get_paper_request_state($str){

		switch ($str) {
			case '0' : $rt ='신청'; break;
			case '1' : $rt='자료 수집중'; break;
			case '2' : $rt='레포트 작성중'; break;
			case '3' : $rt='완료'; break;
			case '4' : $rt='취소'; break;
			default : $rt=''; break;
			}
